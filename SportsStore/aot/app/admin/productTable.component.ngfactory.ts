...
class View_ProductTableComponent1 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._text_17 = this.renderer.createText(this._el_16,' Edit ',(null as any));
...
export class View_ProductTableComponent0 extends import1.AppView<import0.ProductTableComponent> {
  ...
  _text_27:any;
  _el_28:any;
  _RouterLink_28_3:import9.Wrapper_RouterLink;
  _text_29:any;
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._text_13 = this.renderer.createText(this._el_12,'Category',(null as any));
    ...
    this._el_22 = import3.createRenderElement(this.renderer,this._el_0,'tbody',import3.EMPTY_INLINE_ARRAY,(null as any));
    ...
    this._el_28 = import3.createRenderElement(this.renderer,parentRenderNode,'button',new import3.InlineArray4(4,'class','btn btn-primary','routerLink','/admin/main/products/create'),(null as any));
    ...
    this._text_29 = this.renderer.createText(this._el_28,' Create New Product ',(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import14.RouterLink) && ((28 <= requestNodeIndex) && (requestNodeIndex <= 29)))) { return this._RouterLink_28_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_24_0_0:any = this.context.getProducts();
    ...
    const currVal_28_0_0:any = '/admin/main/products/create';
  ...
  createEmbeddedViewInternal(nodeIndex:number):import1.AppView<any> {
    if ((nodeIndex == 24)) { return new View_ProductTableComponent1(this.viewUtils,this,24,this._anchor_24,this._vc_24); }
    return (null as any);
  }

...
export class View_ProductEditorComponent0 extends import1.AppView<import0.ProductEditorComponent> {
  ...
  _NgControl_37_6:any;
  _NgControlStatus_37_7:import12.Wrapper_NgControlStatus;
  _text_38:any;
  _text_39:any;
  _el_40:any;
  _text_41:any;
  _text_42:any;
  _el_43:any;
  _RouterLink_43_3:import15.Wrapper_RouterLink;
  _text_44:any;
  _text_45:any;
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._text_35 = this.renderer.createText(this._el_34,'Price',(null as any));
    this._text_36 = this.renderer.createText(this._el_32,'\n        ',(null as any));
    this._el_37 = import3.createRenderElement(this.renderer,this._el_32,'input',new import3.InlineArray4(4,'class','form-control','name','price'),(null as any));
    ...
    this._NgModel_37_5 = new import14.Wrapper_NgModel(this._ControlContainer_6_4,(null as any),(null as any),this._NG_VALUE_ACCESSOR_37_4);
    ...
    this._el_40 = import3.createRenderElement(this.renderer,this._el_6,'button',new import3.InlineArray4(4,'class','btn btn-primary','type','submit'),(null as any));
    this._text_41 = this.renderer.createText(this._el_40,'',(null as any));
    this._text_42 = this.renderer.createText(this._el_6,'\n    ',(null as any));
    this._el_43 = import3.createRenderElement(this.renderer,this._el_6,'button',new import3.InlineArray8(6,'class','btn btn-secondary','routerLink','/admin/main/products','type','reset'),(null as any));
    ...
    var disposable_5:Function = import3.subscribeToRenderElement(this,this._el_43,new import3.InlineArray2(2,'click',(null as any)),this.eventHandler(this.handleEvent_43));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import18.DefaultValueAccessor) && (29 === requestNodeIndex))) { return this._DefaultValueAccessor_29_3.context; }
    if (((token === import19.NG_VALUE_ACCESSOR) && (29 === requestNodeIndex))) { return this._NG_VALUE_ACCESSOR_29_4; }
    if (((token === import20.NgModel) && (29 === requestNodeIndex))) { return this._NgModel_29_5.context; }
    if (((token === import21.NgControl) && (29 === requestNodeIndex))) { return this._NgControl_29_6; }
    if (((token === import22.NgControlStatus) && (29 === requestNodeIndex))) { return this._NgControlStatus_29_7.context; }
    if (((token === import18.DefaultValueAccessor) && (37 === requestNodeIndex))) { return this._DefaultValueAccessor_37_3.context; }
    if (((token === import19.NG_VALUE_ACCESSOR) && (37 === requestNodeIndex))) { return this._NG_VALUE_ACCESSOR_37_4; }
    if (((token === import20.NgModel) && (37 === requestNodeIndex))) { return this._NgModel_37_5.context; }
    if (((token === import21.NgControl) && (37 === requestNodeIndex))) { return this._NgControl_37_6; }
    if (((token === import22.NgControlStatus) && (37 === requestNodeIndex))) { return this._NgControlStatus_37_7.context; }
    if (((token === import23.RouterLink) && ((43 <= requestNodeIndex) && (requestNodeIndex <= 44)))) { return this._RouterLink_43_3.context; }
    if (((token === import24.NgForm) && ((6 <= requestNodeIndex) && (requestNodeIndex <= 45)))) { return this._NgForm_6_3.context; }
    if (((token === import25.ControlContainer) && ((6 <= requestNodeIndex) && (requestNodeIndex <= 45)))) { return this._ControlContainer_6_4; }
    if (((token === import22.NgControlStatusGroup) && ((6 <= requestNodeIndex) && (requestNodeIndex <= 45)))) { return this._NgControlStatusGroup_6_5.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_37_1_0:any = 'price';
    this._NgModel_37_5.check_name(currVal_37_1_0,throwOnChange,false);
    const currVal_37_1_1:any = this.context.product.price;
    ...
    const currVal_43_0_0:any = '/admin/main/products';
    ...
    const currVal_70:any = this.context.editing;
    ...
    const currVal_71:any = import3.inlineInterpolate(1,'',(this.context.editing? 'Edit': 'Create'),' Product');

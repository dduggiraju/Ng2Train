...
import * as import9 from '../../../app/model/static.datasource';
import * as import10 from '../../../app/model/cart.model';
import * as import11 from '../../../app/model/order.model';
import * as import12 from '../../../app/model/order.repository';
import * as import13 from '../../../app/model/auth.service';
...
class ModelModuleInjector extends import0.NgModuleInjector<import1.ModelModule> {
  ...
  __StaticDataSource_10:import9.StaticDataSource;
  __Cart_11:import10.Cart;
  __Order_12:import11.Order;
  __OrderRepository_13:import12.OrderRepository;
  __AuthService_14:import13.AuthService;
  ...
  get _StaticDataSource_10():import9.StaticDataSource {
    if ((this.__StaticDataSource_10 == null)) { (this.__StaticDataSource_10 = new import9.StaticDataSource()); }
    return this.__StaticDataSource_10;
  }
  get _Cart_11():import10.Cart {
    if ((this.__Cart_11 == null)) { (this.__Cart_11 = new import10.Cart()); }
    return this.__Cart_11;
  }
  get _Order_12():import11.Order {
    if ((this.__Order_12 == null)) { (this.__Order_12 = new import11.Order(this._Cart_11)); }
    return this.__Order_12;
  }
  get _OrderRepository_13():import12.OrderRepository {
    if ((this.__OrderRepository_13 == null)) { (this.__OrderRepository_13 = new import12.OrderRepository(this._RestDataSource_8)); }
    return this.__OrderRepository_13;
  }
  get _AuthService_14():import13.AuthService {
    if ((this.__AuthService_14 == null)) { (this.__AuthService_14 = new import13.AuthService(this._RestDataSource_8)); }
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import9.StaticDataSource)) { return this._StaticDataSource_10; }
    if ((token === import10.Cart)) { return this._Cart_11; }
    if ((token === import11.Order)) { return this._Order_12; }
    if ((token === import12.OrderRepository)) { return this._OrderRepository_13; }
    if ((token === import13.AuthService)) { return this._AuthService_14; }
